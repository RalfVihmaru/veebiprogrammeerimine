...
<body>
  ...
  <!--Teeme modaalakna, w3schoolsi eeskujul-->
  <div id="myModal" class="modal">
	...
	<div id="rating" class="modalcaption">
		<label><input id="ratel" name="rating" type="radio" value="1">1</label>
		<label><input id="ratel" name="rating" type="radio" value="2">2</label>
		<label><input id="ratel" name="rating" type="radio" value="3">3</label>
		<label><input id="ratel" name="rating" type="radio" value="4">4</label>
		<label><input id="ratel" name="rating" type="radio" value="5">5</label>
